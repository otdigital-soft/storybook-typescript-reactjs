    ...
    <Form layout="vertical">
      ...
      <Row gutter={29}>
        ...
        <>
          <Col span={12}>
            <FormInputNumber<FormValues>
              name="fuel_consumption_summer"
              formItemProps={{
                label: labels.fuel_consumption_summer,
                required: true,
              }}
              inputNumberProps={{
                placeholder: prettyPlaceholder`Enter ${labels.fuel_consumption_summer}`,
              }}
            />
          </Col>
          <Col span={12}>
            <FormInputNumber<FormValues>
              name="fuel_consumption_winter"
              formItemProps={{
                label: labels.fuel_consumption_winter,
                required: true,
              }}
              inputNumberProps={{
                placeholder: prettyPlaceholder`Enter ${labels.fuel_consumption_winter}`,
              }}
            />
          </Col>
        </>
        ...
        <>
          ...
          <Col span={12}>
            <FormInputNumber<FormValues>
              ...
              inputNumberProps={{
                placeholder: prettyPlaceholder`Enter ${labels.nox_tax}`,
              }}
            />
          </Col>
        </>
