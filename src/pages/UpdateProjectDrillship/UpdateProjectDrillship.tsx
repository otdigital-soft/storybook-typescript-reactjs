...
const UpdateProjectDrillship = () => {
  ...
  if (isLoadingDrillship || isProjectDataLoading) {
    return (
      <Center flexGrow={1}>
        <Spin />
      </Center>
  ...
  if (drillshipError || projectError || !drillshipData) {
    return (
      <Center flexGrow={1}>
...
export default UpdateProjectDrillship;
