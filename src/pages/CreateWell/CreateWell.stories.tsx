...
export default {
  title: 'pages/CreateWell',
  component: CreateWell,
} as ComponentMeta<typeof CreateWell>;
...
const DemoCreateWell = (props: typeof args) => {
  ...
  return <CreateWell key={key} />;
};

const Template: ComponentStory<typeof DemoCreateWell> = (props) => (
  <DemoCreateWell {...props} />
);
