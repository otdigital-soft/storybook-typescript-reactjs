...
import type { AirgapEnum } from './AirgapEnum';
...
export type CustomSemiRigDetails = {
    name?: string;
    manager?: string;
    design?: string;
    build_yard?: string;
    ...
    thruster_assist?: boolean | null;
    total_anchors?: number | null;
    anchor_standalone?: boolean | null;
    airgap?: (AirgapEnum | BlankEnum);
