...
import { DP_CLASS_DISPLAY, SEMI_LABELS as labels } from 'consts/rigs';
...
const Capacities = ({ rig }: CapacitiesProps) => {
  return (
    <>
      ...
      <Col span={6}>
        <DetailItem label={labels.airgap} value={rig?.airgap as string} />
      </Col>
      <Col span={6}>
        <DetailBooleanItem
      ...
      <Col span={6}>
        <DetailNumberItem
          label={labels.total_anchors}
          value={rig?.total_anchors}
        />
      </Col>
      <Col span={6}>
        <DetailBooleanItem
