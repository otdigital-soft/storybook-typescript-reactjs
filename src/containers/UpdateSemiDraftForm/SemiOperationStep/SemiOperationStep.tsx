...
import { FormValues } from 'containers/UpdateSemiForm';

interface SemiOperationStepProps {
  formikProps: FormikProps<FormValues>;
}

const SemiOperationStep = ({ formikProps }: SemiOperationStepProps) => {
...
export default SemiOperationStep;
