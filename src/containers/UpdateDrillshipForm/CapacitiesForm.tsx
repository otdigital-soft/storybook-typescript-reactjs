  ...
  return (
    <>
      ...
      <FormInputNumber<FormValues>
        ...
        inputNumberProps={{
          placeholder: `Enter ${toLowerCaseFirstLetter(labels.variable_load)}`,
        }}
      />
      <FormInputNumber<FormValues>
      ...
      <FormInputNumber<FormValues>
        ...
        inputNumberProps={{
          placeholder: `Enter ${toLowerCaseFirstLetter(labels.draft_depth)}`,
        }}
      />
      <FormInputNumber<FormValues>
        name="displacement"
        ...
        inputNumberProps={{
          placeholder: `Enter ${toLowerCaseFirstLetter(labels.displacement)}`,
        }}
      />
      <FormInputNumber<FormValues>
        name="hull_breadth"
        ...
        inputNumberProps={{
          placeholder: `Enter ${toLowerCaseFirstLetter(labels.hull_breadth)}`,
        }}
      />
      <FormInputNumber<FormValues>
        name="hull_depth"
      ...
      <FormInputNumber<FormValues>
        ...
        inputNumberProps={{
          placeholder: `Enter ${toLowerCaseFirstLetter(labels.hull_length)}`,
        }}
      />
      <FormInputNumber<FormValues>
        name="derrick_height"
        ...
        inputNumberProps={{
          placeholder: `Enter ${toLowerCaseFirstLetter(labels.derrick_height)}`,
        }}
      />
      <FormInputNumber<FormValues>
      ...
      <FormInputNumber<FormValues>
        ...
        inputNumberProps={{
          placeholder: `Enter ${toLowerCaseFirstLetter(labels.total_cranes)}`,
        }}
      />
      <FormInputNumber<FormValues>
        name="crane_capacity"
        ...
        inputNumberProps={{
          placeholder: `Enter ${toLowerCaseFirstLetter(labels.crane_capacity)}`,
        }}
      />
      <FormInputNumber<FormValues>
      ...
      <FormInputNumber<FormValues>
        ...
        inputNumberProps={{
          placeholder: `Enter ${toLowerCaseFirstLetter(labels.total_bop_rams)}`,
        }}
      />
      <FormInputNumber<FormValues>
      ...
      <FormInputNumber<FormValues>
        ...
        inputNumberProps={{
          placeholder: `Enter ${toLowerCaseFirstLetter(labels.engine_power)}`,
        }}
      />
      <FormInputNumber<FormValues>
      ...
      <FormInputNumber<FormValues>
        ...
        inputNumberProps={{
          placeholder: `Enter ${toLowerCaseFirstLetter(labels.engine_total)}`,
        }}
      />
      <FormInputNumber<FormValues>
